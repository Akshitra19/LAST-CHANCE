...
export interface SyllabusTopic { id: string; code: string; name: string; status: TopicStatus; parentTopicId: string | null; depth: number; displayOrder: number; isOfficial: boolean; children: SyllabusTopic[]; }
...
export interface SyllabusData { version: 'GATE_2027'; subjectCount: number; topicCount: number; subjects: SyllabusSubject[]; }
