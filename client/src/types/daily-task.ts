...
export interface TaskReference { id: string; code: string; name: string; path?: string; }
export interface DailyTask { id: string; taskDate: string; taskType: DailyTaskType; plannedMinutes: number; actualMinutes: number | null; status: DailyTaskStatus; startedAt: string | null; completedAt: string | null; notes: string | null; planKey: string | null; planSlot: number | null; subject: TaskReference | null; topic: TaskReference | null; createdAt: string; updatedAt: string; }
